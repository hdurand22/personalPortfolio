...
import IconBackgroundCircle from "./IconBackgroundCircle";
import IconCircleOutline from "./IconCircleOutline";
import TextLine1 from "./TextLine1";
import TextLine2 from "./TextLine2";
import TextLine3 from "./TextLine3";
...
function Icon({ toggle }) {
    ...
    // Animating circles
    const circles = [
        <IconBackgroundCircle key="circle1" toggle={toggle} delay={750} />,
        <IconCircleOutline key="circle2" d="M441.483 343.55a75.016 75.016 0 1175.016-75.015 75.016 75.016 0 01-75.016 75.016zm0-149.05a74.035 74.035 0 1074.035 74.035 74.035 74.035 0 00-74.035-74.035z" toggle={toggle} delay={500} />,
    ]
